...
SchemaElement.prototype.merge = function(source) {
  ...
  if ((this.$targetNamespace === undefined) || (this.$targetNamespace === source.$targetNamespace)) {
...
WSDL.prototype._initializeOptions = function (options) {
  ...
  this.options.noErrorOnFault = !!options.noErrorOnFault;
};
...
WSDL.prototype.xmlToObject = function(xml, callback) {
  ...
  function finish() {
    ...
    if (root.Envelope) {
      ...
      if (body && body.Fault && !self.options.noErrorOnFault) {
